...
To install, you can use ``pip``:
    ...
    .. code-block:: bash
        ...
        pip install git+https://github.com/pewresearch/django_pewtils#egg=django_pewtils

Or you can install from source:

    .. code-block:: bash

        git clone https://github.com/pewresearch/django_pewtils.git
        cd django_pewtils
